...
hyperparam_path = os.path.join(hyperparameterfolderpath, 'hyperparam_cwcshri_dgpsin.json')
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        filename = f'cwcshri_tradeoff_dgpsin.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'cwcshri_tradeoff_dgpsin_done.pkl'
##########################################
# # Save
