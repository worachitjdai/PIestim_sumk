...
hyperparam_path = os.path.join(hyperparameterfolderpath, 'hyperparam_cwcli_dgpgaussian.json')
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        filename = f'cwcli_tradeoff_dgpgaussian.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'cwcli_tradeoff_dgpgaussian_done.pkl'
##########################################
# # Save
