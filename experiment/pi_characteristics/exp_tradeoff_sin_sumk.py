...
hyperparam_path = os.path.join(hyperparameterfolderpath, 'hyperparam_sumk_dgpsin.json')
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        criterion = sumk_objective(delta_ = delta, gamma_ = gamma, percentlargest_ = hyperparams['percentlargest'], lambda_ = hyperparams['lambda']
        ...
        filename = f'sumk_tradeoff_dgpsin.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'sumk_tradeoff_dgppolysin_done.pkl'
##########################################
# # Save
