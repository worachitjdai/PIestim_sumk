...
gamma_list = np.linspace(0, 0.4, 10) 
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        criterion = sumk_objective(delta_ = delta, gamma_ = gamma, percentlargest_ = 0.3, lambda_ = 0.1
        ...
        saved_result = {'outputs_train':outputs_train_all, 'outputs_val':outputs_val_all
                        ...
                        , 'gamma': gamma_list, 'lambda': 0.1, 'klargest': 0.3}
        

        filename = f'sumk_tradeoff_dgppolynomial.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'sumk_tradeoff_dgppolynomial_done.pkl'
##########################################
# # Save
