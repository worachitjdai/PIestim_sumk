...
# To collect the outputs
gamma_list = np.linspace(8, 15, 10) 
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        criterion = cwcquan_objective(delta_ = delta, gamma_ = gamma, soften_ = 50
                                      , smoothfunction = 'tanh', returnseparatedloss = True)

        train = trainer(num_epochs = 3000, batch_size = 500, patience = 500) 
        ...
        filename = f'cwcquan_tradeoff_dgpmultivariate.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'cwcquan_tradeoff_dgpmultivariate_done.pkl'
##########################################
# # Save
