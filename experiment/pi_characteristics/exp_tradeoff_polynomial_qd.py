...
# To collect the outputs
gamma_list = np.linspace(0, 0.05, 10) 
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        criterion = qd_objective(delta_ = delta, gamma_ = gamma, soften_ = 50
        ...
        filename = f'qd_tradeoff_dgppolynomial.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'qd_tradeoff_dgppolynomial_done.pkl'
##########################################
# # Save
