...
hyperparam_path = os.path.join(hyperparameterfolderpath, 'hyperparam_cwcli_dgppolynomial.json')
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        filename = f'cwcli_tradeoff_dgppolynomial.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'cwcli_tradeoff_dgppolynomial_done.pkl'
##########################################
# # Save
