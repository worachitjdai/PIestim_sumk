...
hyperparam_path = os.path.join(hyperparameterfolderpath, 'hyperparam_cwcli_dgpmultivariate.json')
...
for j in range(N_trials):
    ...
    for i, gamma in enumerate(gamma_list):
        ...
        saved_result = {'outputs_train':outputs_train_all, 'outputs_val':outputs_val_all
                        ...
                        , 'gamma': gamma_list, 'alpha': hyperparams['alpha'], 'beta': hyperparams['beta'], 'train_loss':all_trainloss_list, 'val_loss':all_valloss_list}

        filename = f'cwcli_tradeoff_dgpmultivariate.pkl'
        # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'cwcli_tradeoff_dgpmultivariate_done.pkl'
##########################################
# # Save
