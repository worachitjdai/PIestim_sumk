...
hyperparam_path = os.path.join(hyperparameterfolderpath, 'hyperparam_qrf_dgpsin.json')
...
for j in range(N_trials):
    ...
    filename = f'qrf_performance_dgpsin.pkl'
    # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'qrf_performance_dgpsin.pkl'
##########################################
# # Save
