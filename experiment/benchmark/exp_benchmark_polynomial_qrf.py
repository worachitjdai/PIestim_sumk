...
hyperparam_path = os.path.join(hyperparameterfolderpath, 'hyperparam_qrf_dgppolynomial.json')
...
for j in range(N_trials):
    ...
    filename = f'qrf_performance_dgppolynomial.pkl'
    # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'qrf_performance_dgppolynomial.pkl'
##########################################
# # Save
