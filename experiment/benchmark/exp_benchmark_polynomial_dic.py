...
train = trainer(num_epochs = 3000, batch_size = 500, patience = 200) #Set the trainer
...
for j in range(N_trials):
    ...
    criterion = dic_objective(delta_ = delta, gamma_ = 0.1, soften_ = 50, smoothfunction = 'tanh', returnseparatedloss = True)
    ...
    filename = f'dic_performance_dgppolynomial.pkl'
    # # Save
...
##########################################
print('---------- Finished ----------')
filenamedone = f'dic_performance_dgppolynomial_done.pkl'
##########################################
# # Save
